...
def main():
# ── تشغيل Market Intelligence أولاً ──────────────────
intel = {}
try:
import sys, os
...
intel = run_intel() or {}
print(”\n✅ Market Intelligence جاهز”)
except Exception as e:
print(f”\n⚠️  Market Intelligence: {e}”)

```
# أفضل أسهم من CAN SLIM
intel_stocks = intel.get("top_stocks", [])
